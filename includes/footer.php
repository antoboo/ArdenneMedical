<footer class="footer pt-20">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-lg-4 mt-sm-30 mt-xs-30 footer-latest-news">
						...
						<div class="single-news">
							<h5><a href="appoint.php">How to make an appointment successfully..</a></h5>
							<span> Book Appointments / See your favorite doctors</span>
						</div>
						<div class="single-news">
							<h5><a href="services.php">What services do we offer...</a></h5>
							<span>Rapid Blood Test /  Vaccination</span>
						</div>
				...
				<div align-items=" center" id="footer" class="p-1 bg-success text-white" >
           				 <p class="text-center">Copyright &copy; - Jamaica Medical Center <?php echo date('Y'); ?></p>
