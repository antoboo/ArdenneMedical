...
<div class="container py-5">
  ...
  <!-- Quick Booking Appointments Purpose -->
  ...
  <div class="calendar shadow bg-white p-5">
    ...
    <ol class="days list-unstyled">
      ...
      <li>
        ...
        <div class="event bg-success">Confidence Builder</div>
      </li>
      <li>
      ...
      <li>
        ...
        <div class="event bg-info">Physo Consultant</div>
      </li>
      <li>
      ...
      <li>
        ...
        <div class="event all-day begin span-1 bg-warning">Discounted Massages</div>
      </li>
      <li>
        <div class="date">15</div>
        <div class="event all-day end bg-success">Vaccination</div>
      </li>
      <li>
      ...
      <li>
        ...
        <div class="event bg-primary">Santa Visit</div>
        <div class="event bg-success">Prenatal Classes</div>
      </li>
      <li>
