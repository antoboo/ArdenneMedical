<?php    
        ...
        if(isset($_POST['submit'])) {
            ...
            $printname = $doctorsName["name"];
                        ...
                        if($isSuccess){
                            SendEmail::Sendmail($email,"Welcome to Ardenne Medical Centre", " Hi " .$fname. " ".$lname.",". "<br/> <br/> You have successfully completed the appointment form and you have selected " .$printname." to be your attending doctor. <br/> <br/>You will be contacted shortly to confirm appointment on the contact number $contact provided. ,<br/> <br/> Thank you once again and see you soon $fname. <br/><br/>");
